...
class PropertyModel {
  ...
  factory PropertyModel.fromMap(Map<String, dynamic> json) {
    log("is faccvcvv ${json["is_favourite"]}");
...
class Parameter {
  ...
  static ifListConvertToString(dynamic value) {
    if (value is List) {
      return value.join(",");
    }
    return value;
