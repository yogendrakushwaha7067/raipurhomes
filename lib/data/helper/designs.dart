...
setTitleText(String titleTxt, BuildContext context) {
  return Text(
    titleTxt,
...
appBarWidget(BuildContext context, String titleText,
...
addBackButton(BuildContext context, IconData backButtonIcon) {
  return IconButton(
    onPressed: () {
...
setBlurBg({required BuildContext context, required Widget childWidget}) {
  return ClipRRect(
