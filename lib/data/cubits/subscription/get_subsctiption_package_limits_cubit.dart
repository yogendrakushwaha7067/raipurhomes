...
class GetSubsctiptionPackageLimitsCubit
  ...
  Future<void> getLimits(String packageId) async {
    try {
      ...
      SubcriptionPackageLimit subcriptionPackageLimit =
          await _advertisementRepository.getPackageLimit(
        packageId,
      );
      emit(
        GetSubsctiptionPackageLimitsSuccess(subcriptionPackageLimit),
      );
    } catch (e) {
      emit(GetSubsctiptionPackageLimitsFailure(e.toString()));
    }
  }
