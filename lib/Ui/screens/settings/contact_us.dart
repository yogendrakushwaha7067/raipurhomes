  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, (() {
      if (context.read<CompanyCubit>().state is CompanyInitial ||
          ...
          (context.read<CompanyCubit>().state as CompanyFetchSuccess)
              .companyData
              .isEmpty) {
            ...
            child: Column(
              ...
              children: [
                ...
                customTile(context,
                    ...
                    onTap: () async {
                  var number = state.companyData
                      .firstWhere((element) => element.type == Api.tele1);
                  await launchUrl(Uri.parse("tel:${number.data}"));
                ...
                customTile(context,
                    ...
                    onTap: () {
                  var email = state.companyData
                      .firstWhere((element) => element.type == Api.compEmail);
                  showEmailDialoge(email.data);
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color:
                  context.color.teritoryColor.withOpacity(0.10000000149011612),
