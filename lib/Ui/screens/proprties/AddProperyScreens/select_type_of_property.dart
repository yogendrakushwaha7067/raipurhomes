...
class _SelectPropertyTypeState extends State<SelectPropertyType> {
  ...
  void initState() {
    super.initState();
    // log(ref['sell'].state.toString(), name: "#ff");
    Future.delayed(
      Duration.zero,
      () {
        var setting = context
  ...
  Widget build(BuildContext context) {
    log((cubitReference?.state).toString());
    return Scaffold(
          ...
          child: UiUtils.buildButton(context, onPressed: () {
            ...
            if (state is! GetSubsctiptionPackageLimitsInProgress) {
              ...
              if (selectedCategory != null) {
                Navigator.pushNamed(context, Routes.addPropertyDetailsScreen);
              }
            }
          },
      ...
      body: BlocListener<GetSubsctiptionPackageLimitsCubit,
        ...
        listener: (context, state) {
          ...
          if (state is GetSubsctiptionPackageLimitsSuccess) {
            ...
            log(state.packageLimit.totalLimitOfProperty.toString(),
                name: ":@@@@");
