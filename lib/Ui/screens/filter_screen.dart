...
import 'package:ebroker/Ui/screens/userprofile/sell_form.dart';
...
class FilterScreenState extends State<FilterScreen> {
  ...
  getcurrentlocation() async {
    ...
    placemarks=await placemarkFromCoordinates(_currentPosition!.latitude,
    ...
    print(placemarks.toString()+"hdhdjueikekrkdfkldldl");
  ...
  setDefaultVal({bool isrefresh = true}) {
    if (isrefresh) {
                 ...
                 // const SizedBox(height: 10),
                  SizedBox(
                    ...
                    child: SfRangeSlider(
                      ...
                      inactiveColor: Theme.of(context).colorScheme.teritoryColor,
                      min: 0.0,
                      max: 100,
                      values: _values,
                      interval: 20,
                      ...
                      onChanged: (SfRangeValues values) {
                        setState(() {
                          ...
                          minController.text=    (values.start*100000).toStringAsFixed(0);

                       maxController.text=   (values.end*100000).toStringAsFixed(0);
                        print(maxController.text+"jdjjdjdfjjfjfjf");
                        });
                      },
                    ),
                  ),
  ...
  allCategoriesFilterButton(BuildContext context) {
    return GestureDetector(
      onTap: () {
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: SizedBox(
                    height: 46.rh(context),
                    child: UiUtils.buildButton(context, onPressed: () {
                      if (properyType == Constant.valBuy) {
                        searchbody[Api.propertyType] = "";
                        properyType = "";
                        setState(() {});
                      } else {
                        setPropertyType(Constant.valBuy);
                      }
                    },
                        showElevation: false,
                        textColor: properyType == Constant.valBuy
                            ? context.color.buttonColor
                            : context.color.textColorDark,
                        buttonColor: properyType == Constant.valBuy
                            ? Theme.of(context).colorScheme.teritoryColor
                            : Theme.of(context)
                            .colorScheme
                            .teritoryColor
