...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    var user = context.watch<UserDetailsCubit>().state.user;
    return Scaffold(
                  ...
                  children: [
                   ...
                   // dividerWithSpacing(),
                    ...
                    customTile(
                      context,
                      title:
                          UiUtils.getTranslatedLabel(context, "notifications"),
                    ...
                    customTile(
                      context,
                      title:
                          UiUtils.getTranslatedLabel(context, "areaConvertor"),
                    ...
                    customTile(
                      context,
                      title:
                          UiUtils.getTranslatedLabel(context, "privacyPolicy"),
                    ...
                    customTile(
                      context,
                      title:
                          UiUtils.getTranslatedLabel(context, "deleteAccount"),
